...
####################### Search specific period ################        
  ...
  addi $t0 ,$zero ,0 			#t0 --> counter
   ...
   ask_again:
    ...
    move $a0,$s4 # get the preserved address    					#call split function
    jal split_date
   ...
   move $a0,$s4 # get the preserved address
   jal split_date			###call split function
    ...
    blt $t3,$t7,loop_date        # checking if array_year < from year
    bgt $t3,$t4,loop_date        # checking if array_year> to year
    beq $t3,$t7,check_month1     # if array_year==from year
    beq $t3,$t4,check_month2     # if array_year==to year
    j date_found
